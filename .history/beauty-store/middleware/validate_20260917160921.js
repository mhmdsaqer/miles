...
const productSchema = Joi.object({
  ...
  description_ar: Joi.string().min(0).max(2000).allow(null, "").optional(),
  description_en: Joi.string().min(0).max(2000).allow(null, "").optional(),
  // ✅ ✅ ✅ جديد: المكونات (اختياري)
  ingredients_ar: Joi.string()
  .min(0)
  .max(2000)
  .allow(null, "")
  .optional()
  .messages({
  "string.max": "المكونات بالعربية طويلة جداً (الحد الأقصى 2000 حرف)"
  }),
  ingredients_en: Joi.string()
  .min(0)
  .max(2000)
  .allow(null, "")
  .optional()
  .messages({
  "string.max": "Ingredients in English too long (max 2000 characters)"
  }),
  ...
  .optional()
  .messages({
  "string.max": "طريقة الاستخدام بالعربية طويلة جداً (الحد الأقصى 2000 حرف)"
  }),
  usage_en: Joi.string()
  .min(0)
  .max(2000)
  ...
  .optional()
  .messages({
  "string.max": "Usage instructions in English too long (max 2000 characters)"
  }),
