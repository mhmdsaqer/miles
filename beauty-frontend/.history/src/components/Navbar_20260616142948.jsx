// src/components/Navbar.jsx - النسخة النهائية لحل مشكلة الفراغ الأسود العلوي 🚀
...
const Navbar = () => {
  ...
  return (
    <>
      <nav 
        // 🛠️ التعديل الجوهري: إضافة top-0 left-0 w-full لمنع احتجاز أي مساحة سوداء خلفه
        // وجعله يطفو كلياً كطبقة علوية نقية فوق البانر والصور دون دفعها لأسفل.
      ...
      >
        {/* ✨ جعلنا الخلفية هنا بيضاء ناصعة ومصمتة بالكامل (bg-white) في الوضع الافتراضي ليلغي تماماً رؤية أي سواد أو تداخل ألوان يقع خلف شريط الـ Navbar */}
        <div className={`max-w-[1400px] mx-auto transition-all duration-500 rounded-[2rem] pointer-events-auto ${
          isScrolled 
            ...
            : "bg-white shadow-[0_10px_30px_rgba(0,0,0,0.05)] border border-gray-200/40 py-2.5"
        }`}>
