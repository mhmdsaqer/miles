          ...
          <div className="px-4 md:px-8 flex justify-between items-center h-full">
            ...
            <div className="flex-shrink-0">
              <Link 
                ...
                aria-label={t('home')}
              >
                {/* ✅ التعديل الأول: إضافة overflow-hidden وأبعاد ثابتة لإنشاء "نافذة التكبير" */}
                <div className="relative z-10 animate-float-luxury w-28 h-16 md:w-36 md:h-20 lg:w-44 lg:h-24 flex items-center justify-center overflow-hidden">
                  ...
                  {/* ✅ التعديل الثاني: استخدام scale لتكبير "زووم" للصورة من الداخل */}
                  <img
                    src={LOGO_URL}
                    alt="Company Logo"
                    className={`
                      ...
                      w-full h-full 
                      object-contain 
                      scale-125 md:scale-150 /* هذا هو السطر السحري: يكبر الصورة من الداخل كأنك تقرب الكاميرا */
                      drop-shadow-[0_10px_30px_rgba(0,0,0,0.15)]
                      transition-all duration-700 ease-out
                      ${logoLoaded ? 'opacity-100' : 'opacity-0'}
                      group-hover:drop-shadow-[0_20px_50px_rgba(236,72,153,0.4)]
                      group-hover:scale-[1.6] /* تكبير إضافي عند التحويم */
                    `}
                  ...
                  {/* ✅ Loading Spinner أنيق أثناء التحميل (تم تصغيره ليتناسب مع النافذة) */}
                  {!logoLoaded && (
