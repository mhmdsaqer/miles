          ...
          <div className="px-4 md:px-8 flex justify-between items-center h-full">
            ...
            <div className="flex-shrink-0">
              <Link 
                ...
                aria-label={t('home')}
              >
                {/* ✅ التعديل 1: إضافة bg-transparent بشكل صريح للحاوية */}
                <div className="relative z-10 animate-float-luxury w-28 h-16 md:w-36 md:h-20 lg:w-44 lg:h-24 flex items-center justify-center overflow-hidden bg-transparent">
                  ...
                  {/* ✅ هالة متوهجة (خففت الشفافية قليلاً لتكون أنعم) */}
                  <div className="absolute inset-0 bg-gradient-to-r from-pink-500/20 via-purple-500/20 to-pink-500/20 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-1000 animate-pulse-slow pointer-events-none"></div>
                  
                  {/* ✅ التعديل 2: إضافة bg-transparent للصورة نفسها + ضبط الـ scale */}
                  <img
                    src={LOGO_URL}
                    alt="Company Logo"
                    className={`
                      ...
                      w-full h-full 
                      object-contain 
                      bg-transparent /* ✅ إجبار المتصفح على عدم رسم خلفية */
                      scale-[1.3] md:scale-[1.5] /* ✅ تكبير يملأ الفراغات الشفافة الداخلية */
                ...
                {/* ✅ تأثير وميض خفيف */}
                <div className="absolute inset-0 rounded-full bg-gradient-to-r from-transparent via-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none animate-shimmer"></div>
              </Link>
            </div>
          </div>
        </div>
