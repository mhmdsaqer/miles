// src/components/Navbar.jsx - النسخة النهائية المطورة للفصل اللوني الفاخر ✨
...
const Navbar = () => {
  ...
  return (
    <>
      ...
      >
        {/* ✨ تم تعديل الخلفية هنا: أصبحت بيضاء ناصعة في الأعلى لتعزل محتوى الصورة الخلفية بجمالية متناهية ونظيفة */}
        <div className={`max-w-[1400px] mx-auto transition-all duration-500 rounded-[2rem] pointer-events-auto ${
          isScrolled 
            ...
            : "bg-white shadow-[0_10px_30px_rgba(0,0,0,0.04)] border border-gray-100/40 py-2.5"
        }`}>
