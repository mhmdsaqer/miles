...
const BrandDetails = () => {
    ...
    return (
      <div className="min-h-screen bg-[#FAFAFA] pt-32 px-6 lg:px-12" dir={lang === "ar" ? "rtl" : "ltr"} lang={lang}>
        <div className="max-w-[1400px] mx-auto space-y-10 animate-pulse">
          <div className="w-full aspect-[16/7] bg-gray-100 rounded-[2rem]" />
  ...
  return (
    <div className={`min-h-screen bg-[#FAFAFA] pb-24 ${lang === "ar" ? "font-arabic" : "font-latin"}`} dir={lang === "ar" ? "rtl" : "ltr"} lang={lang}>
      ...
      {/* ===== Hero Banner - تصميم البكسل المثالي الفائق الوضوح المتجاوب والمتناسق 🚀 ===== */}
      <div className="relative bg-gray-950 overflow-hidden pt-16 md:pt-20">
        
        {/* حاوية تعتمد على النسبة الهندسية الحقيقية لأبعاد بانر التصميم لضمان عدم الاقتصاص الحاد */}
        <div className="relative w-full aspect-[16/7.5] sm:aspect-[1920/680] md:aspect-[1920/750] lg:aspect-[1920/822] max-h-[500px] flex items-center justify-center overflow-hidden">
          
          {brand.header_image ? (
            <img
              src={getImageUrl(brand.header_image)}
              alt={`${brandDisplayName} Header`}
              // تفعيل object-cover بشكل كامل مع موازنة التوسيط ليفرش البانر بكامل فخامته وبأعلى دقة متوفرة
          ...
          {/* تظليل علوي ناعم جداً ومنساب للـ NavBar لمنع أي حواف حادة هابطة */}
          <div className="absolute top-0 left-0 right-0 h-16 bg-gradient-to-b from-black/25 to-transparent pointer-events-none z-20" />

          {/* تظليل سفلي خفيف سينمائي يعزل نصوص وعناصر التحكم لتبدو واضحة فوق الصورة المضيئة */}
