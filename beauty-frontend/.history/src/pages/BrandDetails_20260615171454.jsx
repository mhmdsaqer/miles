  ...
  return (
    <div className={`min-h-screen bg-[#FAFAFA] pb-24 ${lang === "ar" ? "font-arabic" : "font-latin"}`} dir={lang === "ar" ? "rtl" : "ltr"} lang={lang}>
      ...
      {/* ✅ ✅ ✅ الحل الجذري: 
          ...
          - ✅ على الهواتف: object-[center_10%] ليأخذ الجزء العلوي من الصورة (60% من المحتوى)
          - ✅ على الديسكتوب: md:object-[center_25%] للجزء العلوي-الأوسط
          - ✅ التعتيم أخف بكثير لإظهار الصورة بوضوح
      */}
        ...
        <div className="relative w-full aspect-[4/5] sm:aspect-[16/10] md:aspect-[2/1] lg:aspect-auto lg:h-[75vh] lg:min-h-[600px] lg:max-h-[900px]">
          ...
          {brand.header_image ? (
            <img
              ...
              // ✅ ✅ ✅ الحل الجذري:
              // - على الهواتف: object-[center_10%] → يأخذ الجزء العلوي من الصورة (أول 10% من الأعلى)
              // - على الديسكتوب: md:object-[center_25%] → يأخذ الجزء العلوي-الأوسط
              className="absolute inset-0 w-full h-full object-cover object-[center_10%] md:object-[center_25%] transition-transform duration-[2000ms] ease-out hover:scale-105"
              loading="eager"
              decoding="async"
            />
          ) : (
          ...
          {/* ✅ 2️⃣ طبقات التعتيم الذكية - ✅ أخف بكثير لإظهار الصورة */}
          {/* Vignette خفيف جداً */}
