  ...
  return (
    <div className={`min-h-screen bg-[#FAFAFA] pb-24 ${lang === "ar" ? "font-arabic" : "font-latin"}`} dir={lang === "ar" ? "rtl" : "ltr"} lang={lang}>
      {brandSeoData && (
        ...
        {/* ===== Hero Banner - العرض الكامل الممتد 100% بالشاشات 🚀 ===== */}
        <div className="relative bg-gray-950 overflow-hidden pt-16 md:pt-20">
          
          {/* حاوية تأخذ عرض الشاشة بالكامل وتلتزم بنسبة أبعاد صورتك المعتمدة */}
          <div className="relative w-full aspect-[16/9] sm:aspect-[1920/822] max-h-[822px] flex items-center justify-center overflow-hidden">
            
            {brand.header_image ? (
              <img
                src={getImageUrl(brand.header_image)}
                alt={`${brandDisplayName} Header`}
                // التعديل هنا: استخدام object-cover لتغطية العرض بالكامل مع object-center لضمان التوسط
            ...
            {/* التدرجات والنصوص المدمجة فوق الصورة */}
            ...
            {/* محتوى الواجهة (اسم البراند، اللوجو، زر العودة...) */}
            <div className={`
            ...
            `}>
              {/* ... باقي كود النصوص والأزرار داخل الهيرو كما هو ... */}
            </div>
