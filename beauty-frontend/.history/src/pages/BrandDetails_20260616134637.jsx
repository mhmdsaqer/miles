...
const BrandDetails = () => {
  ...
  return (
    <div className={`min-h-screen bg-[#FAFAFA] pb-24 ${lang === "ar" ? "font-arabic" : "font-latin"}`} dir={lang === "ar" ? "rtl" : "ltr"} lang={lang}>
      ...
      {/* حاوية بأبعاد هيدر متناسقة ومريحة عمودياً تمنح التصميم مساحة عرض كاملة */}
        <div className="relative w-full aspect-[16/8] sm:aspect-[16/7] md:aspect-[1920/720] lg:aspect-[1920/780] max-h-[520px] flex items-center justify-center overflow-hidden">
          
          {brand.header_image ? (
            <img
              src={getImageUrl(brand.header_image)}
              alt={`${brandDisplayName} Header`}
              // التعديل السحري: تغيير object-center إلى object-top للحفاظ على رأس العارضة وإظهار كامل التصميم العلوي
