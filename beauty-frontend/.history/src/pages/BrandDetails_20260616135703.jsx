// src/pages/BrandDetails.jsx - نسخة دقة البكسل الأصلية الفائقة بدون ضغط 💎
...
const BrandDetails = () => {
  ...
  return (
    <div className={`min-h-screen bg-[#FAFAFA] pb-24 ${lang === "ar" ? "font-arabic" : "font-latin"}`} dir={lang === "ar" ? "rtl" : "ltr"} lang={lang}>
      ...
      {/* ===== Hero Banner - نظام عرض البكسل فائق النقاء لمنع تشوهات أصول السيرفر المضغوطة 🚀 ===== */}
      <div className="relative bg-gray-950 overflow-hidden pt-16 md:pt-20">
        
        {/* حاوية هندسية تعتمد التوزيع المستقر للأبعاد القياسية للويب العريض */}
        <div className="relative w-full aspect-[16/7.5] sm:aspect-[16/6] md:aspect-[1920/580] lg:aspect-[1920/600] max-h-[500px] flex items-center justify-center overflow-hidden">
          ...
          {brand.header_image ? (
            <img
              ...
              // إجبار المتصفح على العرض بأعلى معايير جودة وإلغاء التنعيم التشويهي الناتج عن تقليل الدقة
