// src/pages/Brands.jsx - النسخة المُحسّنة: كروت أصغر + عدد منتجات أنيق ✨
  ...
  const luxuryPalettes = useMemo(() => [
    {
      ...
      dot: "bg-amber-500",
      shadow: "group-hover:shadow-[0_30px_80px_-25px_rgba(217,119,6,0.25)]",
    },
    {
      name: "rose",
      ...
      dot: "bg-rose-500",
      shadow: "group-hover:shadow-[0_30px_80px_-25px_rgba(225,29,72,0.25)]",
    },
    {
      name: "pearl",
      ...
      dot: "bg-stone-600",
      shadow: "group-hover:shadow-[0_30px_80px_-25px_rgba(87,83,78,0.25)]",
    },
    {
      name: "midnight",
      ...
      dot: "bg-slate-600",
      shadow: "group-hover:shadow-[0_30px_80px_-25px_rgba(71,85,105,0.25)]",
    },
    {
      name: "mauve",
      ...
      dot: "bg-purple-500",
      shadow: "group-hover:shadow-[0_30px_80px_-25px_rgba(147,51,234,0.25)]",
    },
  ], []);
      ...
      <div className="min-h-screen bg-gradient-to-b from-white via-stone-50/30 to-white pt-32 px-4 sm:px-6 lg:px-12" dir={lang === "ar" ? "rtl" : "ltr"} lang={lang}>
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 lg:gap-6">
            {[...Array(10)].map((_, i) => (
              <div key={i} className="aspect-square bg-gray-100 rounded-[2rem] animate-pulse" />
            ))}
          </div>
        </div>
      </div>
              ...
              >
                ...
                `}>
                  ...
                  <div className={`absolute top-3 ${lang === "ar" ? "right-4" : "left-4"} z-20`}>
                    <span className="text-[9px] font-black text-gray-400/60 uppercase tracking-widest tabular-nums">
                      #{String(index + 1).padStart(2, '0')}
                    </span>
                  </div>

                  {/* ✅ منطقة اللوجو - في الأعلى */}
                  <div className="relative flex-[1.3] flex items-center justify-center p-5 overflow-hidden">
                    {/* تأثير ضوئي ناعم */}
                    <div className={`
                  ...
                  {/* ✅ فاصل أنيق */}
                  <div className="mx-5 h-px bg-gradient-to-r from-transparent via-gray-300/50 to-transparent" />

                  {/* ✅ معلومات البراند - في الأسفل */}
                  <div className="px-4 py-3 text-center space-y-2 flex-shrink-0">
                    {/* اسم البراند */}
                    <h2 className={`
                    ...
                    <div className={`flex items-center justify-center gap-1.5 ${lang === "ar" ? "flex-row" : "flex-row-reverse"}`}>
                      ...
                      <span className={`text-[10px] font-black ${palette.accentText} tabular-nums`}>
                        {brand.productCount}
                      </span>
