// src/pages/BrandDetails.jsx - نسخة الدقة الفائقة والوضوح البانورامي المعتمد (1920x600) 💎
...
const BrandDetails = () => {
  ...
  return (
    <div className={`min-h-screen bg-[#FAFAFA] pb-24 ${lang === "ar" ? "font-arabic" : "font-latin"}`} dir={lang === "ar" ? "rtl" : "ltr"} lang={lang}>
      ...
      {/* ===== Hero Banner - نظام العرض الاحترافي الفاخر مانع الاقتصاص 🚀 ===== */}
      <div className="relative bg-gray-950 overflow-hidden pt-16 md:pt-20">
        
        {/* الحاوية الهندسية المتجاوبة: تم حسابها لتعرض الأبعاد بدقة متناهية وتحافظ على استقرار الصورة كاملة */}
        <div className="relative w-full aspect-[16/7.5] sm:aspect-[16/6] md:aspect-[1920/580] lg:aspect-[1920/600] max-h-[500px] flex items-center justify-center overflow-hidden">
          
          {brand.header_image ? (
            <img
              src={getImageUrl(brand.header_image)}
              alt={`${brandDisplayName} Header`}
              // الحفاظ الكامل على دقة البكسلات الحقيقية من الحافة إلى الحافة دون عمل زوم داخلي جائر
          ...
          <div className="absolute top-0 left-0 right-0 h-20 bg-gradient-to-b from-black/30 to-transparent pointer-events-none z-20" />

          {/* تظليل سفلي خفيف سينمائي يعزل نصوص وعناصر التحكم لتبدو واضحة فوق الصورة المضيئة */}
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/10 to-transparent z-15 pointer-events-none" />
