          ...
          <div className="px-4 md:px-8 flex justify-between items-center h-full">
            ...
            <div className="flex-shrink-0 flex items-center justify-center">
              <Link 
                ...
                aria-label={t('home')}
              >
                <div className="relative z-10 animate-float-luxury flex items-center justify-center">
                  ...
                  {/* ✅✅✅ التعديل الجذري هنا: استخدام max-h بدلاً من h لمنع تمدد الـ Navbar */}
                  <img
                    src={LOGO_URL}
                    alt="Company Logo"
                    className={`
